...
PennController.PreloadZip("https://vicgom14.dreamhosters.com/experiment_media/Daoxin/homophone/low.zip");
...
// Completion screen
newTrial("completion",
    newText("thanks", "<p>Before you go, you should know that one of the purposes of this study is to find out what people do when they are in a word learning experiment like this. In particular, we want to know whether you took notes during the learning phase rather than committing things to memory. That is, did you write down (or type in) what you thought each word meant and use that to answer during the test? It is important that you answer this question truthfully. No matter how you answer, you will still get paid for your participation in the study. Thank you!</p>")
        .center()
        .print()
    ,
    newText("yes", "Yes")
...
newTrial( "final" ,
    ...
    .print()
,
newText("<p><a href='https://upenn.sona-systems.com/webstudy_credit.aspx?experiment_id=969&credit_token=6011ad02ed97467b8f9dffbffed97587&survey_code="+ GetURLParameter("id")+"' target='_blank'>Click here to confirm your participation on SONA.</a></p> <p>This is a necessary step in order for you to receive credit!</p>")
.center()
.print()
,
newButton("void")
